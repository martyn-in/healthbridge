      ...
      <div className="w-full md:w-1/2 p-6 sm:p-10 lg:p-16 flex flex-col justify-center items-center bg-[#F8FAFC]">
        <div className="w-full max-w-md space-y-8 text-center">
          ...
          <div className="space-y-3 text-center">
            <div className="w-14 h-14 rounded-2xl bg-[#2F3273] text-white flex items-center justify-center mx-auto shadow-xl">
              <Logo size="md" showText={false} />
            </div>
            ...
            <p className="text-xs text-[var(--text-secondary)] font-semibold max-w-sm mx-auto">
              Sign in with your verified Google account to access your medical records, dosages, and AI clinical consultations.
            </p>
          </div>
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full py-4 px-6 rounded-2xl bg-[#4D50A2] hover:bg-[#3B3D80] text-white font-extrabold text-sm shadow-xl shadow-[#4D50A2]/25 transition-all flex items-center justify-center gap-3 active:scale-[0.99] border border-white/20"
            >
    ...
    <Suspense
      fallback={
        <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC]">
          <div className="text-center font-bold text-slate-500">Loading Medical Portal...</div>
        </div>
      }
    >
      <LoginContent />
