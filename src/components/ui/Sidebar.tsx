...
export const Sidebar: React.FC = () => {
  ...
  return (
    <>
      {/* ── DESKTOP SIDEBAR ─────────────────────────────────────── */}
      <aside
        className="hidden lg:flex flex-col w-64 h-screen sticky top-0 shrink-0 z-20 bg-white/90 dark:bg-[#18181D]/90 backdrop-blur-xl border-r border-[#6E56CF]/10 dark:border-white/10 shadow-sm"
      >
        {/* Logo */}
