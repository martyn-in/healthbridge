...
const sidebarLinks = [
  ...
  { name: "Symptoms & AI", href: "/dashboard/patient/symptoms", icon: Activity },
  { name: "Emergency SOS", href: "/dashboard/patient/emergency", icon: HeartPulse, textClass: "text-red-500" },
];
  ...
  return (
    <aside className="w-72 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border-r border-gray-200 dark:border-zinc-800 h-screen flex flex-col transition-all">
      <div className="p-6 flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-500 to-emerald-400">
          HealthBridge
        </h1>
      </div>
      ...
      <div className="p-4 border-t border-gray-200 dark:border-zinc-800 flex items-center justify-between">
        ...
        <button className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800">
