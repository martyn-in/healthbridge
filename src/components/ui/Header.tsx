    ...
    <header className="sticky top-0 z-30 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-colors">
      ...
      <div className="flex h-16 items-center justify-between px-4 sm:px-6 gap-4">
        ...
        <div className="flex items-center gap-3 lg:hidden">
          ...
          <span className="font-extrabold text-navy-900 dark:text-white text-sm">HealthBridge AI</span>
        </div>
        ...
        <div className="hidden lg:flex items-center flex-1 max-w-md relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-xs sm:text-sm rounded-xl bg-slate-100 dark:bg-slate-800 border-none text-slate-800 dark:text-slate-100 placeholder-slate-400 focus:ring-2 focus:ring-teal-500 outline-none"
          />
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {onOpenHealthCard && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-teal-50 dark:bg-teal-950/40 text-teal-700 dark:text-cyan-400 border border-teal-200 dark:border-teal-800/60 text-xs font-bold hover:bg-teal-100 transition-colors"
          ...
          <button
            onClick={triggerSos}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-red-600 hover:bg-red-700 text-white text-xs font-bold shadow-md shadow-red-500/20 transition-transform active:scale-95 animate-pulse"
          >
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 p-2 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 text-xs font-semibold transition-colors"
            >
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 p-1.5 sm:px-3 sm:py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-xs font-semibold transition-colors"
            >
              ...
              <div className="absolute right-0 mt-2 w-56 rounded-xl bg-white dark:bg-slate-900 shadow-xl border border-slate-200 dark:border-slate-800 p-2 z-50 animate-in fade-in duration-150">
                ...
                {profiles.map((p) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-lg text-xs font-medium flex items-center justify-between hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors ${
